...
urlpatterns = [
    ...
    # path("zoom-oauth-connections/<str:object_id>", zoom_oauth_connections_api_views.ZoomOAuthConnectionDetailPatchDeleteView.as_view(), name="zoom-oauth-connection-detail-patch-delete"),
]
